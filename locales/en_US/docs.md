...
File Encryption & Decryption is a free [opensource] web app that provides secure file encryption in the browser.
...
---
It's easy to self host and deploy File Encryption & Decryption, you can do that either with npm
...
```bash
git clone https://github.com/darkkD11/File_encrypti_decrypt
```

2. move to the folder

```bash
cd File File_encrypti_decrypt
```
...
5. start File Encryption & Decryption
...
1. Open File Encryption & Decryption.
...
Files encrypted with File Encryption & Decryption are identifiable by looking at the file signature that is used by the app to verify the content of a file, Such signatures are also known as magic numbers or Magic Bytes. These Bytes are authenticated and cannot be changed.
...
No, File Encryption & Decryption never stores any of your data. It only runs locally in your browser.

<hr style="height: 1px">

### Is File Encryption & Decryption free?

Yes, File Encryption & Decryption is free and always will be.

<hr style="height: 1px">

### Which file types are supported? Is there a file size limit?

File Encryption & Decryption accepts all file types. There's no file size limit, meaning files of any size can be encrypted.
...
File Encryption & Decryption uses authenticated encryption. The sender must provide their private key, a new shared key will be computed from both keys to encrypt the file. Recipient has to provide their private key when decrypting also. this way can verify that the encrypted file was not tampered with, and was sent from the real sender.
...
### Why should I use File Encryption & Decryption?
...
### When should I not use File Encryption & Decryption?
...
[opensource]: https://github.com/darkkD11/File_encrypti_decrypt
...
[github]: https://github.com/darkkD11/File_encrypti_decrypt
